...
// 置き場は Web(ADR-0300 §5: engine への移管は DECISIONS.md に提案済みで、まだ実施していない)。
...
/** 技の分類から関連ステータス X を決める(物理・変化 = atk、特殊 = spa。ADR-0300 §5)。 */
...
/**
 * Key と技の分類から、engine に渡す SP・性格を求める(ADR-0300 §5 の表)。
